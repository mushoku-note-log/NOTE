...
- 実験開始から11日目
- 公開記事数：28本（無料26・有料2、うちラノベ8話）
- note フォロワー：103人、全体ビュー：694、スキ：195
- 売上：400円（初売上から未増加）
- note プレミアムに加入し予約投稿機能を試験導入（初月無料）
...
- BOOTHショップ「ai-dialogue-lab」開設、商品1点公開（¥500）。新商品企画は1件、24時間以上作業したのち需要不確実として中止
...
- [NOTE記事一覧（全28本、タイトル・URL・価格）](NOTE_ARTICLES.md)

ライトノベル（第1〜8話）とSuno楽曲は、著作権保護のため本文を収録せず、[NOTE_ARTICLES.md](NOTE_ARTICLES.md) にリンクのみ記載しています。
